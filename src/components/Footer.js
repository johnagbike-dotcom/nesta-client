...
const SOCIALS = [
  { label: "Instagram", href: "https://www.instagram.com/nestanaija/",                    emoji: "📸" },
  { label: "Facebook",  href: "https://www.facebook.com/profile.php?id=61587022831024",   emoji: "👥" },
  { label: "LinkedIn",  href: "https://www.linkedin.com/company/nesta-naija/",            emoji: "💼" },
  { label: "YouTube",   href: "https://www.youtube.com/@NestaNaija",                      emoji: "▶️" },
  { label: "WhatsApp",  href: "https://wa.me/2348138588058",                              emoji: "💬" },
];
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-10 md:px-6 md:py-12">
            ...
            <div className="mt-5 flex items-center gap-3 flex-wrap">
              {SOCIALS.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  title={s.label}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-white/10 bg-white/4 text-white/55 text-xs hover:border-amber-400/40 hover:text-amber-300 hover:bg-amber-400/6 transition-all duration-200"
                >
                  <span>{s.emoji}</span>
                  <span>{s.label}</span>
                </a>
          ...
          <div className="grid grid-cols-2 gap-x-12 gap-y-8 text-sm md:grid-cols-3 md:gap-x-20">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><Link to="/explore" className={linkClass}>Browse stays</Link></li>
                <li><Link to="/post-ad" className={linkClass}>List your property</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li><Link to="/about" className={linkClass}>About NestaNg</Link></li>
                <li><Link to="/press" className={linkClass}>Press &amp; media</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><Link to="/cancellation-policy" className={linkClass}>Cancellations &amp; refunds</Link></li>
                <li><Link to="/cookie-policy" className={linkClass}>Cookie policy</Link></li>
                <li><Link to="/trust-and-safety" className={linkClass}>Trust &amp; Safety</Link></li>
        ...
        <div className="mt-8 flex flex-col gap-4 border-t border-white/10 pt-5 md:mt-10 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-white/55">
            <a href="mailto:hello@nestanaija.com" className="transition-colors duration-300 hover:text-amber-300">
              hello@nestanaija.com
            </a>
            <span className="hidden text-white/20 md:inline">•</span>
            <a href="mailto:support@nestanaija.com" className="transition-colors duration-300 hover:text-amber-300">
